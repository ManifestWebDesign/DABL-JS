...
/* Class.js */
(function(){var a=false,b=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;function c(e,f,g){var d;for(d in e){f[d]=typeof e[d]==="function"&&typeof g[d]==="function"&&b.test(e[d])?(function(h,i){return function(){var k=this._super,j;this._super=g[h];j=i.apply(this,arguments);this._super=k;return j}})(d,e[d]):e[d]}}this.Class=function(){};Class.extend=function(g,h){if(typeof g==="undefined"){g={}}if(typeof h==="undefined"){h={}}var f,e;a=true;f=new this();a=false;function d(){if(!a&&this.init){this.init.apply(this,arguments)}}for(e in this){if(!(e in h)&&this.hasOwnProperty(e)){d[e]=this[e]}}c(g,f,this.prototype);c(h,d,this);d.prototype=f;d.prototype.constructor=d;return d}})();
