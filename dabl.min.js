...
/* RESTAdapter.js */
(function(c){function e(g){g=g+"";return g.length===2?g:"0"+g}function b(g){return f(g,true).replace(/%26/gi,"&").replace(/%3D/gi,"=").replace(/%2B/gi,"+")}function f(h,g){return encodeURIComponent(h).replace(/%40/gi,"@").replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace((g?null:/%20/g),"+")}function d(k,n){this.template=k;this.defaults=n||{};var h=this.urlParams={},m=k.split(/\W/);for(var j=0,g=m.length;j<g;++j){var o=m[j];if(o&&k.match(new RegExp("[^\\\\]:"+o+"(\\W|$)"))){h[o]=true}}this.template=k.replace(/\\:/g,":")}d.prototype={url:function(l){var i=this,j=this.template,k,h;l=l||{};for(var g in this.urlParams){k=typeof l[g]!=="undefined"||l.hasOwnProperty(g)?l[g]:i.defaults[g];if(typeof k!=="undefined"&&k!==null){h=b(k);j=j.replace(new RegExp(":"+g+"(\\W)","g"),h+"$1")}else{j=j.replace(new RegExp("(/?):"+g+"(\\W)","g"),function(n,o,m){if(m.charAt(0)==="/"){return m}else{return o+m}})}}return j},urlGet:function(j){var g=this.url(j);j=j||{};g=g.replace(/\/?#$/,"");var i=[];for(var h in j){if(!this.urlParams[h]){i.push(f(h)+"="+f(j[h]))}}i.sort();g=g.replace(/\/*$/,"");return g+(i.length?"?"+i.join("&"):"")}};this.RESTAdapter=this.Adapter.extend({_routes:null,_urlBase:"",init:function a(g){this._super();this._routes={};if(g){this._urlBase=g}},_route:function(g){if(!g){throw new Error("Cannot create RESTful route for empty url.")}if(this._routes[g]){return this._routes[g]}return this._routes[g]=new d(this._urlBase+g)},_save:function(o,g){var p,k=o.constructor,m,n=this._route(k._url),j={},h=Deferred(),i=k.getKey(),q=this;for(p in k._fields){var l=k._fields[p];m=o[p];if(k.isTemporalType(l.type)){m=this.formatDate(m,l.type)}j[p]=m}c.ajax({url:n.url(j),type:"POST",data:JSON.stringify(j),contentType:"application/json;charset=utf-8",dataType:"json",headers:{"X-HTTP-Method-Override":g},success:function(s){if(!s||(s.errors&&s.errors.length)){h.reject(s);return}o.fromJSON(s).resetModified().setNew(false);if(i&&o[i]){q.cache(k._table,o[i],o)}h.resolve(o)},error:function(r,t,s){h.reject({xhr:r,status:t,errors:[s]})}});return h.promise()},formatDateTime:function(g){if(!(g instanceof Date)){g=new Date(g)}var h=-g.getTimezoneOffset()/60;h=(h>0?"+":"-")+e(Math.abs(h));return this.formatDate(g)+" "+e(g.getHours())+":"+e(g.getMinutes())+":"+e(g.getSeconds())+" "+h+"00"},insert:function(g){return this._save(g,"POST")},update:function(g){if(!g.isModified()){var h=Deferred();h.resolve(g);return h.promise()}return this._save(g,"PUT")},remove:function(g){var j=g.constructor,i=this._route(j._url),l=Deferred(),k=j.getKey(),h=this;c.ajax({url:i.url(g.toJSON()),type:"POST",data:{},contentType:"application/json;charset=utf-8",dataType:"json",headers:{"X-HTTP-Method-Override":"DELETE"},success:function(m){if(m&&m.errors&&m.errors.length){l.reject(m);return}if(k&&g[k]){h.cache(j._table,g[k],null)}l.resolve(g)},error:function(m,o,n){l.reject({xhr:m,status:o,errors:[n]})}});return l.promise()},find:function(i,m){var h=this._route(i._url),l={},k=Deferred(),g=null,j;if(arguments.length===2&&(typeof m==="number"||typeof m==="string")){g=this.cache(i._table,m);if(g){k.resolve(g);return k.promise()}}j=this.findQuery.apply(this,arguments);j.limit(1);l=j.getSimpleJSON();c.get(h.urlGet(l),function(n){if(!n||(n.errors&&n.errors.length)){k.reject(n);return}if(n instanceof Array){n=n.shift()}k.resolve(i.inflate(n))}).fail(function(n,p,o){k.reject({xhr:n,status:p,errors:[o]})});return k.promise()},findAll:function(h){var k=this.findQuery.apply(this,arguments);var g=this._route(h._url),j=k.getSimpleJSON(),i=Deferred();c.get(g.urlGet(j),function(l){if(!l||(l.errors&&l.errors.length)){i.reject(l);return}if(!(l instanceof Array)){l=[l]}i.resolve(h.inflateArray(l))}).fail(function(l,n,m){i.reject({xhr:l,status:n,errors:[m]})});return i.promise()}})})(jQuery);

/* RESTAdapterAngular.js */
(function(){this.AngularRESTAdapter=this.RESTAdapter.extend({$http:null,init:function(a,b){this._super(a);this.$http=b},_save:function(i,a){var j,e=i.constructor,g,h=this._route(e._url),d={},b=Deferred(),c=e.getKey(),k=this;for(j in e._fields){var f=e._fields[j];g=i[j];if(e.isTemporalType(f.type)){g=this.formatDate(g,f.type)}d[j]=g}this.$http({url:h.url(d),method:"POST",data:d,headers:{"X-HTTP-Method-Override":a}}).success(function(l){if(!l||(l.errors&&l.errors.length)){b.reject(l);return}i.fromJSON(l).resetModified().setNew(false);if(c&&i[c]){k.cache(e._table,i[c],i)}b.resolve(i)}).error(function(l,n,m){b.reject({status:n})});return b.promise()},remove:function(a){var d=a.constructor,c=this._route(d._url),f=Deferred(),e=d.getKey(),b=this;this.$http({url:c.url(a.toJSON()),method:"POST",data:{},headers:{"X-HTTP-Method-Override":"DELETE"}}).success(function(g){if(g&&g.errors&&g.errors.length){f.reject(g);return}if(e&&a[e]){b.cache(d._table,a[e],null)}f.resolve(a)}).error(function(g,i,h){f.reject({status:i,errors:[h]})});return f.promise()},find:function(c,g){var b=this._route(c._url),f={},e=Deferred(),a=null,d;if(arguments.length===2&&(typeof g==="number"||typeof g==="string")){a=this.cache(c._table,g);if(a){e.resolve(a);return e.promise()}}d=this.findQuery.apply(this,arguments);d.limit(1);f=d.getSimpleJSON();this.$http.get(b.urlGet(f)).success(function(h){if(!h||(h.errors&&h.errors.length)){e.reject(h);return}if(h instanceof Array){h=h.shift()}e.resolve(c.inflate(h))}).error(function(h,j,i){e.reject({status:j,errors:[i]})});return e.promise()},findAll:function(c){var f=this.findQuery.apply(this,arguments);var a=this._route(c._url),e=f.getSimpleJSON(),d=Deferred();var b=a.urlGet(e);this.$http.get(b).success(function(g){if(!g||(g.errors&&g.errors.length)){d.reject(g);return}if(!(g instanceof Array)){g=[g]}d.resolve(c.inflateArray(g))}).error(function(g,i,h){d.reject({status:i,errors:[h]})});return d.promise()}})})();
