...
//			}
	...
	describe('routing', function(){
		it ('should create correct url routes', function(){
			...
			r = new Route('accounts/:accountId/widgets/:id');
			expect(r.urlGet({id: 5})).toEqual('accounts/widgets/5');
			expect(r.urlGet({accountId: 10})).toEqual('accounts/10/widgets');
			expect(r.urlGet()).toEqual('accounts/widgets');
		});
	});
});